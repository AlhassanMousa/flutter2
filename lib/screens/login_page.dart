...
import 'package:flutter_application_3/services/api_serivce.dart';
...
//https://us-central1-takweed-eg.cloudfunctions.net/client/initial/initialrequest
              ...
              () {
                if (validateAndSave()) {
                  ...
                  APIService.login(model).then(
                    (response) {
                      developer.log('my response  $response');
